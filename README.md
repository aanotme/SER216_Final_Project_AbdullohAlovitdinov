...
1. Parking system should work without any interruptions - 24/
2. A reliable and fast coding language supposed to be used to make it as fast as possible
